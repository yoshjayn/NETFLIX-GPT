...
const dispatch = useDispatch()
  ...
  return (
    <div className='absolute flex justify-between w-screen px-8 py-2 bg-black from-black z-10'>
      <img className='w-44' src = {LOGO} 
       alt='logo'/>
       
      { select &&
      <div className='flex p-2 items-center'>
        <button className='py-2 px-3 mx-4 my-2  w-34 text-black bg-red-600 rounded-3xl' onClick={handleGptSearchClick}>🔎</button>
        <img 
        className='w-10 h-10'
